...
#ifndef kwsys_SharedForward_h
#  define kwsys_SharedForward_h
...
/*
  ...
  #endif
  #define kwsys_SHARED_FORWARD_DIR_BUILD "/path/to/foo-build/bin"
  #define kwsys_SHARED_FORWARD_PATH_BUILD "." CONFIG_DIR_POST
  #define kwsys_SHARED_FORWARD_PATH_INSTALL "../lib/foo-1.2"
  #define kwsys_SHARED_FORWARD_EXE_BUILD CONFIG_DIR_PRE "foo-real"
  #define kwsys_SHARED_FORWARD_EXE_INSTALL
  "../lib/foo-1.2/foo-real"
  #define kwsys_SHARED_FORWARD_OPTION_COMMAND "--command"
  #define kwsys_SHARED_FORWARD_OPTION_PRINT "--print"
  #define kwsys_SHARED_FORWARD_OPTION_LDD "--ldd"
  #if defined(CMAKE_INTDIR)
  # define kwsys_SHARED_FORWARD_CONFIG_NAME CMAKE_INTDIR
  #endif
  #include <kwsys/SharedForward.h>
  int main(int argc, char** argv)
  {
    return kwsys_shared_forward_to_real(argc, argv);
  }
...
#    error "Must define kwsys_SHARED_FORWARD_DIR_BUILD"
#  endif
#  if !defined(KWSYS_SHARED_FORWARD_DIR_BUILD)
...
#    error "Must define kwsys_SHARED_FORWARD_PATH_BUILD"
#  endif
#  if !defined(KWSYS_SHARED_FORWARD_PATH_BUILD)
#    define KWSYS_SHARED_FORWARD_PATH_BUILD                                   \
...
#    error "Must define kwsys_SHARED_FORWARD_PATH_INSTALL"
#  endif
#  if !defined(KWSYS_SHARED_FORWARD_PATH_INSTALL)
#    define KWSYS_SHARED_FORWARD_PATH_INSTALL                                 \
...
#    error "Must define kwsys_SHARED_FORWARD_EXE_BUILD"
#  endif
#  if !defined(KWSYS_SHARED_FORWARD_EXE_BUILD)
...
#    error "Must define kwsys_SHARED_FORWARD_EXE_INSTALL"
#  endif
#  if !defined(KWSYS_SHARED_FORWARD_EXE_INSTALL)
#    define KWSYS_SHARED_FORWARD_EXE_INSTALL                                  \
...
#      define KWSYS_SHARED_FORWARD_OPTION_PRINT                               \
        kwsys_SHARED_FORWARD_OPTION_PRINT
#    endif
#  else
...
#      define KWSYS_SHARED_FORWARD_OPTION_LDD                                 \
        kwsys_SHARED_FORWARD_OPTION_LDD
#    endif
#  else
...
static int kwsys_shared_forward_to_real(int argc, char** argv_in)
{
...
#else
#  error "kwsys/SharedForward.h should be included only once."
#endif
