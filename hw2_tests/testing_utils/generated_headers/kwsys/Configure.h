...
#    error "kwsys/Configure.h must be included before sys/types.h"
#  endif
/* Enable the large file API if it is available.  */
#  if kwsys_LFS_AVAILABLE &&                                      \
    !defined(kwsys_LFS_NO_DEFINES)
#    if !defined(_LARGEFILE_SOURCE) &&                                        \
      !defined(kwsys_LFS_NO_DEFINE_LARGEFILE_SOURCE)
#      define _LARGEFILE_SOURCE
#    endif
#    if !defined(_LARGEFILE64_SOURCE) &&                                      \
      !defined(kwsys_LFS_NO_DEFINE_LARGEFILE64_SOURCE)
#      define _LARGEFILE64_SOURCE
#    endif
#    if !defined(_LARGE_FILES) &&                                             \
      !defined(kwsys_LFS_NO_DEFINE_LARGE_FILES)
#      define _LARGE_FILES
#    endif
#    if !defined(_FILE_OFFSET_BITS) &&                                        \
      !defined(kwsys_LFS_NO_DEFINE_FILE_OFFSET_BITS)
