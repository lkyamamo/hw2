...
#ifndef kwsys_SystemTools_hxx
#define kwsys_SystemTools_hxx
...
namespace kwsys_VA_LIST {
using namespace std;
typedef va_list hack_va_list;
}
namespace kwsys {
typedef kwsys_VA_LIST::hack_va_list va_list;
}
#endif // va_list
 ...
 */
class kwsys_EXPORT SystemToolsManager
{
public:
  SystemToolsManager();
  ~SystemToolsManager();
 ...
 */
class kwsys_EXPORT SystemTools
{
public:
  /** -----------------------------------------------------------------
