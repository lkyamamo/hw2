...
# We save the output from Make in this case, and have to do a make clean first.
# Case 4:
...
function(add_makefile_problem)
	...
	if(NOT EXISTS "${HW_DIR}/Makefile")
		message(WARNING "Cannot find Makefile in user hw${HW_NUMBER} directory -- skipping tests for ${AMP_NAME}")
		return()
	endif()
...
function(gen_grade_target)
	...
	add_custom_target(grade
		...
		COMMAND ${CMAKE_CTEST_COMMAND} -T Test --output-on-failure --no-compress-output -C $<CONFIG> --timeout ${TEST_TIMEOUT} || true   # generate XML logfile
